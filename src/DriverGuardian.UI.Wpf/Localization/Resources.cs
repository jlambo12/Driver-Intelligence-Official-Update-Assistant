...
public static class Resources
{
    ...
    public static string Recommendation_Official_Source_Format => GetString(nameof(Recommendation_Official_Source_Format));
    public static string Recommendation_Official_Source_Not_Applicable => GetString(nameof(Recommendation_Official_Source_Not_Applicable));
    public static string Recommendation_Official_Source_Blocked_By_Safety => GetString(nameof(Recommendation_Official_Source_Blocked_By_Safety));
    ...
    public static string Settings_Scan_Profile_Label => GetString(nameof(Settings_Scan_Profile_Label));
    public static string Settings_Scan_Profile_Hint => GetString(nameof(Settings_Scan_Profile_Hint));
    public static string Settings_Scan_Profile_Minimal => GetString(nameof(Settings_Scan_Profile_Minimal));
    public static string Settings_Scan_Profile_Balanced => GetString(nameof(Settings_Scan_Profile_Balanced));
    public static string Settings_Scan_Profile_Comprehensive => GetString(nameof(Settings_Scan_Profile_Comprehensive));
