...
public static class Resources
{
    ...
    public static string Settings_Diagnostic_Logging_State_Enabled => GetString(nameof(Settings_Diagnostic_Logging_State_Enabled));
    public static string Settings_Diagnostic_Logging_State_Disabled => GetString(nameof(Settings_Diagnostic_Logging_State_Disabled));
